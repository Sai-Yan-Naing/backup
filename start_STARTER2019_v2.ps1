...
# PHP�ݒ�
#Add-WebConfiguration /system.webServer/fastCGI -value @{fullPath="C:\Program Files (x86)\PHP\v5.6.37-nts\php-cgi.exe";arguments="-d open_basedir=E:\webroot\LocalUser\$ORIGIN_USER\${USER_NAME}"}
#$PHP_Handler = 'C:\Program Files (x86)\PHP\v5.6.37-nts\php-cgi.exe|-d open_basedir=E:\webroot\LocalUser\$ORIGIN_USER\'+${USER_NAME}
...
Add-WebConfiguration /system.webServer/fastCGI -value @{fullPath="C:\Program Files\PHP\v7.2.9-nts\php-cgi.exe";arguments="-d open_basedir=E:\webroot\LocalUser\${ORIGIN_USER}\${USER_NAME}"}
$PHP_Handler = 'C:\Program Files\PHP\v7.2.9-nts\php-cgi.exe|-d open_basedir=E:\webroot\LocalUser\'+${ORIGIN_USER}+'\'+${USER_NAME}
Add-Webconfiguration -filter /system.webServer/handlers -location $USER_NAME -pspath "IIS:" -value @{name='PHP7.3-FastCGI1';path='*.php';verb='*';modules='FastCgiModule';scriptProcessor=$PHP_Handler}
...
#$user_name = "sub_user"
$target_path = "E:\webroot\LocalUser\$ORIGIN_USER\$USER_NAME"
