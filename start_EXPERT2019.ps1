...
# PHP設定
#Add-WebConfiguration /system.webServer/fastCGI -value @{fullPath="C:\PHP\php-cgi.exe";arguments="-d open_basedir=E:\webroot\LocalUser\${USER_NAME}"}
#$PHP_Handler = 'C:\PHP\php-cgi.exe|-d open_basedir=E:\webroot\LocalUser\'+${USER_NAME}
...
Add-WebConfiguration /system.webServer/fastCGI -value @{fullPath="C:\PHP7.4.16\php-cgi.exe";arguments="-d open_basedir=E:\webroot\LocalUser\${USER_NAME}"}
$PHP_Handler = 'C:\PHP7.4.16\php-cgi.exe|-d open_basedir=E:\webroot\LocalUser\'+${USER_NAME}
Add-Webconfiguration -filter /system.webServer/handlers -location $USER_NAME -pspath "IIS:" -value @{name='php-7.4.16';path='*.php';verb='*';modules='FastCgiModule';scriptProcessor=$PHP_Handler}
